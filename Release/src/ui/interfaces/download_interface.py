...
from qfluentwidgets import ScrollArea, SubtitleLabel, BodyLabel, CaptionLabel, PushButton, FluentIcon, ProgressBar
from ...services.download_service import DownloadService, DownloadTask, DownloadStatus
...
class DownloadItemWidget(QWidget):
    ...
    def _get_status_text(self) -> str:
        status_map = {DownloadStatus.PENDING: "等待中", DownloadStatus.FETCHING: "获取信息...",
                     DownloadStatus.DOWNLOADING: "下载中", DownloadStatus.COMPLETED: "已完成",
                     DownloadStatus.FAILED: "失败", DownloadStatus.CANCELLED: "已取消"}
...
class DownloadInterface(ScrollArea):
    ...
    def _clear_completed(self) -> None:
        completed_ids = [task_id for task_id, widget in self._item_widgets.items()
