...
from PyQt6.QtWidgets import QVBoxLayout, QHBoxLayout, QFrame, QLabel, QApplication
from PyQt6.QtGui import QPixmap, QPainter, QPainterPath, QBrush, QPalette
...
class DramaCard(QFrame):
    ...
    # 信号
    clicked = pyqtSignal(object)  # DramaInfo
    favorite_clicked = pyqtSignal(object, bool)  # DramaInfo, is_favorite
